...
- For links that must stay clickable in generated PDFs, use real `<a href="...">` anchors; JavaScript `click` / `window.open` navigation is not a dependable substitute in PDF viewers.
